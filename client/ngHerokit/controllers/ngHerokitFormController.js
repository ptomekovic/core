angular.module("ngHerokit").controller("ngHerokitFormController", ['$scope', '$stateParams', '$controller', '$meteorCollection', '$meteorObject', 'HeroPage', 'APPCONFIG', '$collection', '$mdToast', '$rootScope', '$meteorSubscribe', '$Herokit', '$meteor', '$mdDialog', '$state',
    function ($scope, $stateParams, $controller, $meteorCollection, $meteorObject, HeroPage, APPCONFIG, $collection, $mdToast,  $rootScope, $meteorSubscribe, $Herokit, $meteor, $mdDialog, $state) {
        'use strict';
